...
vim.keymap.set("n", "gd", tb.lsp_definitions, { noremap = true, silent = true, desc = "Go to definition (Telescope)" })
vim.keymap.set("n", "gr", tb.lsp_references, { noremap = true, silent = true, desc = "Find references (Telescope)" })
vim.keymap.set(
	"n",
	"gi",
	tb.lsp_implementations,
	{ noremap = true, silent = true, desc = "Go to implementation (Telescope)" }
)
vim.keymap.set("n", "gp", vim.lsp.buf.hover, { noremap = true, silent = true })
...
-- Debugging (DAP)
api.nvim_set_keymap("n", "<Leader>f", ":lua require('dap').continue()<CR>", { noremap = true, silent = true })
api.nvim_set_keymap("n", "<Leader>fw", ":lua require('dap').close()<CR>", { noremap = true, silent = true })
api.nvim_set_keymap("n", "<F10>", ":lua require('dap').step_over()<CR>", { noremap = true, silent = true })
api.nvim_set_keymap("n", "<F11>", ":lua require('dap').step_into()<CR>", { noremap = true, silent = true })
api.nvim_set_keymap("n", "<F12>", ":lua require('dap').step_out()<CR>", { noremap = true, silent = true })
api.nvim_set_keymap("n", "<Leader>d", ":lua require('dap').toggle_breakpoint()<CR>", { noremap = true, silent = true })
...
api.nvim_set_keymap("n", "f", "<Plug>(easymotion-bd-f)", {})
api.nvim_set_keymap("n", "t", "<Plug>(easymotion-bd-t)", {})
api.nvim_set_keymap("n", "<Leader>j", "<Plug>(easymotion-j)", {})
api.nvim_set_keymap("n", "<Leader>k", "<Plug>(easymotion-k)", {})
